...
module.exports.run = async function ({ api, event, args }) {
 ...
 return api.sendMessage("Kar Birthday mention koro too age!!", event.threadID);
 }
 ...
 sendMessage(`Hey happy Birthday , @${name}!\n🎉HAPPY BIRTHDAY🎉`);
 const messages = [
 ...
 { delay: 26000, msg: `শুভ হোক তোমার আগামী দিন।💖\nতোমার এই মুখের হাসি যেন সারাজীবন এমনি থাকুক, হ্যাপি বার্থডে @${name}` },
